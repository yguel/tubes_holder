...
It is super easy to modify the parameters in `tubes_holder__parameters.py <https://github.com/yguel/tubes_holder/blob/main/tubes_holder__parameters.py>`_ stored in the class `TubeHolder` and see the changes reflected in the 3D model.
If you want less holes, walls with different thickness, or other modifications, simply edit the corresponding parameters in `tubes_holder__parameters.py <https://github.com/yguel/tubes_holder/blob/main/tubes_holder__parameters.py>`_ and re-run the script in cq-editor.
